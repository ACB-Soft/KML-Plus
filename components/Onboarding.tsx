...
const Onboarding: React.FC<Props> = ({ onFinish }) => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-200 h-full animate-in overflow-hidden px-8 py-6 md:py-10 justify-between">
      <div className="flex flex-col items-center w-full space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col items-center w-full max-w-sm mx-auto space-y-3 md:space-y-4">
